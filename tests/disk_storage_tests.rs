...
// ============================================================================
// DISK STORAGE INTEGRATION TESTS
// ============================================================================
// Tests the API with DiskStorage backend. These tests verify API behavior
// without git-specific verification (file existence/deletion checks without git).
