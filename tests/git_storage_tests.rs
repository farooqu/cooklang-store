...
// ============================================================================
// Tests the API with GitStorage backend. In addition to API behavior,
// these tests verify git repository state (commits, file tracking, etc).
...
// ============================================================================
// RECIPE CREATION TESTS WITH GIT VERIFICATION
// ============================================================================
...
// ============================================================================
// RECIPE UPDATE TESTS WITH GIT VERIFICATION
// ============================================================================
...
async fn test_update_recipe() {
    ...
    // Verify original file exists in git repo
    ...
    let initial_commits = count_git_commits(&temp_dir);
    ...
    // Verify git commit was made for the update
    let final_commits = count_git_commits(&temp_dir);
    assert!(
        final_commits > initial_commits,
        "Expected new commit after update"
    );
}
...
// ============================================================================
// RECIPE DELETE TESTS WITH GIT VERIFICATION
// ============================================================================
...
async fn test_delete_recipe() {
    ...
    // Verify file exists before deletion in git repo
    ...
    // Verify git commit was made for the deletion
    let final_commits = count_git_commits(&temp_dir);
    assert!(
        final_commits > initial_commits,
        "Expected new commit after deletion"
    );
}
...
// ============================================================================
// NESTED CATEGORY STRUCTURE TESTS
// ============================================================================
